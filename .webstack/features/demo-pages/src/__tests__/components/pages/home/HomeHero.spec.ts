...
describe("HomeHero", () => {
  ...
  it("renders hero title", () => {
    const wrapper = mountWithPlugins(HomeHero)
    expect(wrapper.text()).toContain("Modern Vue")
  })
  ...
  it("renders hero description", () => {
    ...
    expect(text).toContain("A clean, performant Vue 3 starter template")
    expect(text).toContain("TypeScript")
    expect(text).toContain("optimized developer experience")
  })
})
