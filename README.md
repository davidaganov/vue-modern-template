...
**[Repository](https://github.com/davidaganov/vue-modern-template)** | **[Docs](https://aganov.dev/en/docs/guides/templates/vue-modern-template)**

Vue 3 + Vite template source for [@davidaganov/stack](https://www.npmjs.com/package/@davidaganov/stack): TypeScript, clean architecture, and optional Tailwind CSS, Pinia, i18n, and Vitest.
...
| Path                   | Purpose                 |
| :--------------------- | :---------------------- |
| `template-empty/`      | Bare Vue + Vite project |
